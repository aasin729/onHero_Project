  ...
  return (
    <div className="">
      ...
      <div
        ...
        className="w-full bg-white text-black flex flex-col items-center justify-center py-20 border-t border-gray-300"
      >
        <h2 className="text-3xl font-bold mb-20">UN군 총 참전 현황</h2>
        <div className="grid grid-cols-5 gap-10 text-center">
          <div>
            <p className="text-2xl font-semibold mb-2">참전 총인원</p>
            <p className="text-4xl font-bold">{animatedValues.personnel.toLocaleString()}명</p>
          </div>
          <div>
            <p className="text-2xl font-semibold mb-2">전사 총인원</p>
            <p className="text-4xl font-bold">{animatedValues.deaths.toLocaleString()}명</p>
          </div>
          <div>
            <p className="text-2xl font-semibold mb-2">부상 총인원</p>
            <p className="text-4xl font-bold">{animatedValues.injuries.toLocaleString()}명</p>
          </div>
          <div>
            <p className="text-2xl font-semibold mb-2">실종 총인원</p>
            <p className="text-4xl font-bold">{animatedValues.missing.toLocaleString()}명</p>
          </div>
          <div>
            <p className="text-2xl font-semibold mb-2">포로 총인원</p>
            <p className="text-4xl font-bold">{animatedValues.prisoners.toLocaleString()}명</p>
          </div>
        </div>
      </div>
