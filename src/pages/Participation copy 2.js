...
const Participation = () => {
  ...
  return (
    <div className="relative h-screen bg-black flex items-center justify-center">
      {/* 부모 요소에 flex, items-center, justify-center로 중앙 정렬 */}
      <div
        ref={globeEl}
        className="w-full h-full" // 비율 유지
      />
      {selectedCountry && (
        <div
          className="absolute top-1/2 right-10 bg-gray-100 p-4 rounded-lg shadow-lg w-1/4"
          style={{
            maxHeight: "80vh",
            overflowY: "auto",
